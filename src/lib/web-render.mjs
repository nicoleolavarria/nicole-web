...
export function estiloCss(data){
...
export function fuentesHref(data){
  var e = mezclar(data).estilo;
  var qs = [];
...
export const ALT_GENERICO = "Nicole Olavarría, soprano y artista escénica";
...
export function anuncioHtml(data){
...
export function headerHtml(data){
  var d = mezclar(data);
...
export function htmlDocumento(pagina, data, opciones){
  var o = opciones || {};
  var d = mezclar(data);
